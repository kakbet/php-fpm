...
LABEL Maintainer="Atakan Atik <aatik@platingaming.com>" \
...
# Metadata
LABEL org.opencontainers.image.vendor="Atakan Atik" \
    org.opencontainers.image.url="https://github.com/platingaming/php-$PHP_VERSION" \
    org.opencontainers.image.title="PHP-FPM v$PHP_VERSION Alpine" \
    org.opencontainers.image.description="PHP-FPM v$PHP_VERSION with essential extensions on top of Alpine Linux." \
    org.opencontainers.image.version="$PHP_VERSION" \
    org.opencontainers.image.documentation="https://github.com/platingaming/php-$PHP_VERSION"
